        ...
        items: [
          {
            ...
            definition: [
              {
                index: "1",
                main: "Know your Sandbox: <ul><li>SOCIAL STOP</li><li>TERRY STOP - Reasonable Suspicion</li><li>PROBABLE CAUSE</li></ul>"
              },
              {
                index: "2",
                main: "A scene is never Code-4 until you&apos;ve ran a name."
              },
              {
                index: "3",
                main: "Priority 1 calls MUST be finished by end of shift. This includes booking people into jail."
              },
              {
                index: "4",
                main: "*67 Phone Calls to block your number."
              },
              {
                index: "5",
                main: "On a call that contains element of DV but the crime itself is not DV, no DV suppliment may be required."
              },
              {
                index: "6",
                main: "XXXXXXXXX"
