        ...
        items: [
          {
            ...
            definition: [
              { "index": "1", "main": "Know Your Sandbox: Differentiate between a Social Stop, Terry Stop, and Probable Cause." },
              { "index": "2", "main": "Code-4 Scene: Always run names before declaring Code-4." },
              { "index": "3", "main": "Priority Calls: Ensure Priority 1 calls are resolved by the end of your shift." },
              { "index": "4", "main": "Serving Protection Orders: Verify identity and service date before leaving." },
              { "index": "5", "main": "Order Violation: Two prior convictions elevate the violation to a Class C Felony." },
              { "index": "6", "main": "Executing Warrants: Notify a supervisor for high-risk warrants." },
              { "index": "7", "main": "Vehicle Recovery: Match plate and VIN before proceeding." },
              { "index": "8", "main": "DV Elements: DV supplement may not be required if not classified as DV." },
              { "index": "9", "main": "Mental Health ITA: Focus on Danger to Self, Others, Property, or Gravely Disabled." },
              { "index": "10", "main": "Burglary Investigation: Establish containment and request backup resources." },
              { "index": "11", "main": "DUI Stop: Document PC thoroughly after field sobriety tests." },
              { "index": "12", "main": "Traffic Stops: Plan approach and verify plate and owner details." },
              { "index": "13", "main": "DOA Management: Notify a supervisor if suspicious circumstances arise." },
              { "index": "14", "main": "Trespassing: Confirm keyholder&apos;s intent to pursue action." },
              { "index": "15", "main": "Retail Theft: Complete ID and trespass forms when assisting loss prevention." },
              { "index": "16", "main": "Suicidal Subjects: Build rapport using &apos;It seems like...&apos; or &apos;It sounds like...&apos;" },
              { "index": "17", "main": "Booking: Remove firearms and turn off body-worn cameras before entering booking." },
              { "index": "18", "main": "Incident Command: Define roles such as staging, containment, and investigation." },
              { "index": "19", "main": "K9 Announcements: Log announcements in CAD every 5 minutes." }
